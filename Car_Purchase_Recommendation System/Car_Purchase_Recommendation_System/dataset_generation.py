...
large_car_dataset = pd.DataFrame([generate_random_car_data(i) for i in range(1, 5001)])

# Export the dataset to a CSV file
large_car_dataset.to_csv("car_dataset.csv", index=False)

print("New dataset generated and saved as 'car_dataset.csv'")
